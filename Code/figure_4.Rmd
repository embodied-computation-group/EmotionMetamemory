...
title: "Figure 4" output: html_notebook editor_options:
...
WARNING: PACMAN WILL AUTOLOAD NEEDED PACKAGES - USE AT YOUR OWN RISK!
=====================================================================

Otherwise, just manually install these packages.
================================================

pacman::p_load("plyr", "tidyr", "lattice", "ggplot2", "dplyr", "patchwork", "afex", "emmeans", "ggpol", "psychReport", "knitr", "cowplot","readr", "rmarkdown","Rmisc","devtools","gghalves","plotrix", "here")

abs_dic <- dirname(rstudioapi::getSourceEditorContext()$path) setwd(abs_dic)

data_dir <- file.path(dirname(abs_dic), "Data/Preprocessed/JASP")
...
Assemble plots into overall figure.\`\``{r}

mp<- P_MeanBPM + P_pnn50 + P_hf_peak + P_SD2 + plot_layout(guides = 'collect', ncol = 2)

ggsave(file.path(figure_dir, "Figure3.svg"), plot=mp, width = 10, height = 6,dpi=600) ggsave(file.path(figure_dir, "Figure3.png"), plot=mp, width = 10, height = 6,dpi=600) ggsave(file.path(figure_dir, "Figure3.jpeg"), plot=mp, width = 10, height = 6,dpi=600)
